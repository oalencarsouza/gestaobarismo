# 🚀 Sprint Atual: Sprint 2 - Funcionalidades e Integração

---

## 📋 Informações Gerais
- **Nome da Sprint:** Sprint 2 - Persistência de Dados e Experiência do Usuário
- **Data de Início:** 26/02/2026
- **Data de Término:** 12/03/2026 (Previsão)
- **Responsável:** @seu-usuario

## 🎯 Objetivo da Sprint
O objetivo deste ciclo é realizar a integração com o banco de dados para tornar o CRUD de produtos funcional e iniciar a adaptação da interface para dispositivos móveis, visando o uso pelos clientes no bar.

## 🛠️ Backlog da Sprint (Tarefas)
...
- **Foco Mobile:** Atenção especial à responsividade para permitir pedidos via celular em dias de pico.
